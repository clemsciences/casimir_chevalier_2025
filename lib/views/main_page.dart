...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MainCasimirScaffold(
      body: LayoutBuilder(builder: (c, constraints) => PopScope(
                    ...
                    SelectableText.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text:
                            "Découvrez l'exposition sur Casimir Chevalier pour ",
                          ),
                          TextSpan(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Visiter le site internet', style: TextStyle(color: Colors.white)),
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(SatStyle.lightBlueColor),
                      ),
                    ),
                  ],
                ),
